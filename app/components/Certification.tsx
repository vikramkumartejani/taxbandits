  ...
  return (
    <div>
      <div className="border-l border-y border-r-0 border-black flex items-center gap-3">
        ...
        <div className="font-bold text-[1.15rem]">Certification</div>
      </div>
      <p className="text-base font-normal font-helveticaLight leading-[21px] py-1">
        Under penalties of perjury, I certify that:{" "}
      </p>
      <p className="text-base font-normal font-helveticaLight text-black">
        1. The number shown on this form is my correct taxpayer identification
        number (or I am waiting for a number to be issued to me); and{" "}
      </p>
      <div className="py-4 flex">
        <p className="text-base font-normal font-helveticaLight text-black">
          2. If you have been notified by the IRS that you are subject to backup
          withholding
        </p>
        <div className="pl-4">
      ...
      <p className="text-base font-normal font-helveticaLight text-black pl-4 leading-[19px] pr-4">
      ...
      <p className="mt-1.5 text-base font-normal font-helveticaLight text-black leading-[19px]">
