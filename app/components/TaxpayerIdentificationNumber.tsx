        ...
        <div className="pl-1 w-[35%]">
          <div className="w-full">
            <div className="px-[12px] w-full">
              <div className="text-base font-medium mb-0.5">
              ...
              <div className="w-full">
                <input
                  ...
                  id="city"
                  name="city"
                  className="form-control rounded border border-red-600 outline-[#3097f3] w-[90%] h-full p-[10px]"
                />
                <div className="text-[#ff5252] text-sm mt-0.5 font-medium">EIN required</div>
              </div>
            </div>
          </div>
        </div>
